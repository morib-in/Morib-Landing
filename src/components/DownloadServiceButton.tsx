...
const DownloadServiceButton = ({
  iconSrc,
  iconAlt,
  children,
  onClick,
  downloadUrl
}: DownloadServiceButtonProps) => {
  const buttonStyle = "flex px-[1.5rem] py-[2rem] items-center gap-[0.9rem] rounded-[8px] bg-gray-bg-02 text-center text-white subhead-semibold-20 hover:bg-gray-bg-03";
